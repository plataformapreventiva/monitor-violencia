...
# Alertas para último mes

Para hacer rangos y alertas sobre todos los municipios, usamos un algoritmo
mixto:

- Aplicamos primero el método Farrington flexible. 
Si el algoritmo converge, y hay suficientes
datos (dos años atrás), utilizamos su salida.
...
En la siguiente tabla mostramos que cuando hay menos de un año de datos,
